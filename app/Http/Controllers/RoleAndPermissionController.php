...
class RoleAndPermissionController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:etest role & permission view', only: ['index', 'show']),
            new Middleware('permission:etest role & permission create', only: ['create', 'store']),
            new Middleware('permission:etest role & permission edit', only: ['edit', 'store']),
            new Middleware('permission:etest role & permission delete', only: ['destroy']),
        ];
    }
