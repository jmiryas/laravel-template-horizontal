...
class UserController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:etest user view', only: ['index', 'show']),
            new Middleware('permission:etest user create', only: ['create', 'store']),
            new Middleware('permission:etest user edit', only: ['edit', 'update']),
            new Middleware('permission:etest user delete', only: ['destroy']),
        ];
    }
